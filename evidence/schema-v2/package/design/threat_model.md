...
**Mitigations:** strict future JSON Schema; `additionalProperties=false`; duplicate-key rejection; strings/booleans only; canonicalization; recomputed provenance/replay; deterministic first-error ordering.
