...
|---|---|---|---|
| `read_only_observation` | `valid` | `valid` | **PASS** |
| `local_reversible_mutation` | `valid` | `valid` | **PASS** |
| `protected_mutation` | `valid` | `valid` | **PASS** |
| `external_outbound` | `valid` | `valid` | **PASS** |
| `financial_commitment` | `valid` | `valid` | **PASS** |
| `identity_or_access_change` | `valid` | `valid` | **PASS** |
| `destructive_action` | `valid` | `valid` | **PASS** |
| `activation_or_authority_change` | `valid` | `valid` | **PASS** |
| `unknown` | `valid` | `valid` | **PASS** |
| `observe_indeterminate` | `valid` | `valid` | **PASS** |
| `policy_conflict_valid` | `valid` | `valid` | **PASS** |
| `contract_unknown_valid` | `valid` | `valid` | **PASS** |
| `evidence_insufficient_valid` | `valid` | `valid` | **PASS** |
| `authority_indeterminate_valid` | `valid` | `valid` | **PASS** |
