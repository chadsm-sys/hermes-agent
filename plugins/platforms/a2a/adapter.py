...
class A2AAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        # ``is_reconnect`` is part of BasePlatformAdapter.connect; A2A has no
        # server-side update queue to preserve, so the flag is accepted for
        # gateway/reconnect compatibility and otherwise ignored.
