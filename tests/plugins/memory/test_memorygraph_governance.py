...
def test_new_exclusive_claim_includes_unresolved_contradictions(engine, store, entity):
    engine.assert_claim(
        entity["id"],
        "employer",
        "Facility A",
...
def test_resolution_supersedes_other_active_exclusive_claim(engine, store, entity):
    engine.assert_claim(
        entity["id"],
        "employer",
        "Facility A",
